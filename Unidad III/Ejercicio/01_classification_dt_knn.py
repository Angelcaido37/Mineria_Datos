...
df = pd.read_csv("Unidad III\Ejercicio\loan_recovery_dataset.csv")
...
param_grid_tree = {
    "clf__max_depth": [3, 5, 7, 9, None],                # Profundidad máxima
    "clf__min_samples_split": [2, 10, 50, 100],          # Mínimo para dividir
    "clf__min_samples_leaf": [1, 5, 20, 50],             # Mínimo en hoja
